...
(function (factory) {
  ...
  if (typeof exports === 'object') {
    ...
    if (typeof angular === 'undefined' || typeof Chart === 'undefined')
      throw new Error('Chart.js library needs to be included, see http://jtblin.github.io/angular-chartApp.js/');
  ...
  /**
   * Wrapper for chartApp.js
   * Allows configuring chart js using the provider
   *
   * angular.module('myModule', ['chartApp.js']).config(function(ChartJsProvider) {
